...
const appMeta = {
    ...
    'Pascalator': {
        colorClass: 'yellow', url: '/pascalator/', icon: '/images/icons/pascalator.png',
        description: 'Feature screenshots for Pascalator - the free interactive Pascal\'s triangle explorer and binomial expansion practice tool for Level 2 Further Maths and A Level.',
        firstImage: 'https://www.korovatron.co.uk/images/galleries/pascalator/explorePascals.png',
    },
    'The Crate Escape': {
    ...
    'Diya\'s Flashcards': {
        colorClass: 'orange', url: '/flashcards/', icon: '/images/icons/flashcards.png',
        description: 'Feature screenshots for Diya\'s Flashcards - free digital flashcards covering the entire AQA A Level Computer Science specification.',
        firstImage: 'https://www.korovatron.co.uk/images/galleries/flashcards/diyaFlashCard.png',
    },
    'Mandelscope': {
